...
class AccountLender extends StatefulWidget {
  @override
  _AccountLenderState createState() => _AccountLenderState();
}

class _AccountLenderState extends State<AccountLender> {
  ...
  Future<void> fetchUserProfile() async {
    ...
    try {
      ...
      // Uri uri = Uri.parse('http://192.168.1.6:3000/profile');
            ...
            TextButton(
              onPressed: () async {
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          FirstPage()), // Ensure FirstPage is correctly named
                );
              },
